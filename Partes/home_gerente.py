...
def abrir_logistica():
    subprocess.Popen(["python", "sedes.py"])  # abre el archivo sedes.py
...
if len(sys.argv) > 1:
    ...
    # --- Botones de módulos ---
    logistica = Button(frame, width=30, text='Ver información de Logística', border=0, bg="#0089a1", cursor='hand2', fg="#ffffff", command=abrir_logistica)
